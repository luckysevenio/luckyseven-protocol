...
export function NavBar() {
  ...
  function handleProvider(provider: ethers.providers.Web3Provider) {
    dispatch({
  ...
  async function handleConnect() {
    try {
      ...
      // @ts-ignore
      handleProvider(new ethers.providers.Web3Provider(window.ethereum));
  ...
  return (
    <Navbar bg="primary" variant="dark" expand="lg">
      <Container>
        <Navbar.Brand href="/">XMargin</Navbar.Brand>
